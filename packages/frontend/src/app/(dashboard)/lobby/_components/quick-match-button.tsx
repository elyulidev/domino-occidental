  ...
  return (
    <div className="flex flex-col items-start gap-2">
      <button
        ...
        onClick={joinQueue}
        disabled={isJoining}
        className="inline-flex shrink-0 items-center gap-2 rounded-xl bg-gradient-to-r from-gold-500 to-gold-600 px-8 py-3.5 text-base font-semibold text-black shadow-xl shadow-gold-500/20 transition-all hover:from-gold-400 hover:to-gold-500 hover:shadow-gold-500/30 active:scale-[0.97] disabled:cursor-not-allowed disabled:opacity-60 disabled:active:scale-100"
      >
        {isJoining ? (
          <svg
            className="h-5 w-5 animate-spin"
        ...
        {isJoining ? "Conectando..." : "Jugar ahora"}
      </button>
