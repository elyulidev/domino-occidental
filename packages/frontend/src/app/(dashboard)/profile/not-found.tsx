  ...
  return (
    <div className="flex min-h-dvh items-center justify-center bg-linear-to-b from-domino-950 via-domino-900 to-domino-800 px-4">
      ...
      <div className="relative flex flex-col items-center text-center">
        ...
        <Link
          href="/lobby"
          className="mt-8 inline-flex items-center gap-2 rounded-xl bg-linear-to-r from-gold-500 to-gold-600 px-6 py-2.5 text-sm font-semibold text-domino-950 shadow-lg shadow-gold-500/20 transition-all hover:from-gold-400 hover:to-gold-500 active:scale-[0.97]"
        >
          <svg
            viewBox="0 0 24 24"
            fill="none"
