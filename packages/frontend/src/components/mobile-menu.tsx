      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-domino-800 px-5 py-4">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-linear-to-b from-gold-400 to-gold-600 shadow-lg">
              <svg
                viewBox="0 0 24 24"
                fill="none"
                className="h-5 w-5 text-domino-950"
                aria-hidden="true"
              >
                <rect
                  x="3"
  ...
  return (
    <>
      <button
        ...
        aria-expanded={open}
        className="flex h-8 w-8 items-center justify-center rounded-lg border border-domino-700 text-domino-300 transition-colors hover:bg-domino-700 hover:text-white"
      >
        <svg
          role="img"
          viewBox="0 0 24 24"
